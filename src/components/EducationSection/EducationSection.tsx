        ...
        >
          <Card>
            ...
            <CardContent className="text-xs text-muted-foreground space-y-2">
              <p>
                Specialized in <strong>Computer Science</strong>,
                <strong> Artificial Intelligence</strong>, and
                <strong> Software Engineering</strong>.
              </p>
              <ul className="list-disc list-inside space-y-1">
                <li>Led a team in building a blockchain-assisted healthcare system as part of the engineering curriculum</li>
                <li>Developed strong public speaking and professional communication skills</li>
                <li>Presented technical solutions using clear and engaging PowerPoint presentations</li>
              </ul>
            </CardContent>
          </Card>
          {/* <Card>
